 ...
 * @author William
 */
public class __SolicitarServicioChangeOil extends javax.swing.JFrame {

    /**
     * Creates new form __SolicitarServicioChangeOil
     */
    public __SolicitarServicioChangeOil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/__Imagenes/CambioAceite2.png"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 450, 220, 130));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/__Imagenes/CambiarAceite.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 500, 310));
        ...
        jLabel9.setText("SELECCIONE SU AUTO EL CUAL DESEA EL SERVICIO DE CAMBIO DE ACEITE:");
        ...
        jPanel1.add(btnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 420, 330, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if(buscaCliente == null){
            ...
            if(CargarMisCoches != null){
                ...
                lblCostoServicio.setText("El costo del servicio es de $900");
            }
        }  
    ...
    private void btnFacturarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFacturarActionPerformed
        if((comboMisCoches.getSelectedItem().toString() != "Seleccione su vehiculo") && (comboMisCoches.getSelectedItem().toString() != "")){  
            if(comboTecnicos.getSelectedItem().toString() != "Seleccione el tecnico"){
                ...
                ControlOperador.registraNuevoServicio(txtIdentificador.getText(), comboMisCoches.getSelectedItem().toString(), comboTecnicos.getSelectedItem().toString(), "Cambio Aceite", 900);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(__SolicitarServicioChangeOil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new __SolicitarServicioChangeOil().setVisible(true);
            }
        });
    }
