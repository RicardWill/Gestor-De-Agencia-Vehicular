 ...
 * @author William
 */
public class __SolicitarServicioLlantas extends javax.swing.JFrame {

    /**
     * Creates new form __SolicitarServicioLlantas
     */
    public __SolicitarServicioLlantas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/__Imagenes/Neumatico.png"))); // NOI18N
        ...
        jPanel1.add(btnFacturar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 370, 330, -1));
        ...
        jPanel1.add(btnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 420, 240, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/__Imagenes/CambiarLlantas.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 366, 500, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if(buscaCliente == null){
            ...
            if(CargarMisCoches != null){
                ...
                lblCostoServicios.setText("El costo del servicio es de $600");
            }
        }  
    ...
    private void btnFacturarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFacturarActionPerformed
        if((comboMisCoches.getSelectedItem().toString() != "Seleccione su vehiculo") && (comboMisCoches.getSelectedItem().toString() != "")){  
            if(comboTecnicos.getSelectedItem().toString() != "Seleccione el tecnico"){
                ...
                ControlOperador.registraNuevoServicio(txtIdentificador.getText(), comboMisCoches.getSelectedItem().toString(), comboTecnicos.getSelectedItem().toString(), "Cambio Llantas", 600);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(__SolicitarServicioLlantas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new __SolicitarServicioLlantas().setVisible(true);
            }
        });
    }
